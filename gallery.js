        ...
        <div class="card">
          ...
          <div class="card-body shadow-5-strong" id="card-id-${art1Id}">
            ...
            <a href="GalleryArt.html">
              <input type="button" value="COMMENTS" class="btn btn-lg btn-outline-black" style="margin: 0" id="btn-comments-id-${art1Id}" data-id=${art1Id} data-image-url=${art1ImageUrl}>
            </a>
          </div>
        </div>
        <br>`;
